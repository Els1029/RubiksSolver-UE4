...
public class OpenCV : ModuleRules
{
	public OpenCV(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64)
		{
			...
			PublicAdditionalLibraries.Add(Path.Combine(OpenCVFinalLibraryPath, "opencv_world455.lib"));
			//PublicAdditionalLibraries.Add(Path.Combine(OpenCVFinalLibraryPath, "opencv_world455d.lib"));
			//add dynamic library
			PublicDelayLoadDLLs.Add("opencv_videoio_ffmpeg455_64.dll");
			PublicDelayLoadDLLs.Add("opencv_world455.dll");
			PublicDelayLoadDLLs.Add("opencv_world455d.dll");
			RuntimeDependencies.Add(new RuntimeDependency(Path.Combine(OpenCVFinalLibraryPath, "opencv_videoio_ffmpeg455_64.dll"))); //for package
			RuntimeDependencies.Add("$(TargetOutputDir)/opencv_world455.dll");
			RuntimeDependencies.Add(new RuntimeDependency(Path.Combine(OpenCVFinalLibraryPath, "opencv_world455.dll")));  //for package
			//RuntimeDependencies.Add(new RuntimeDependency(Path.Combine(OpenCVFinalLibraryPath, "opencv_world455d.dll")));
		...
		else if (Target.Platform == UnrealTargetPlatform.Android)
		{
			...
			string[] ThirdLibName = { "libcpufeatures.a", "libIlmImf.a", "liblibjasper.a", "liblibjpeg.a",
				...
				"libade.a", "libittnotify.a", "liblibjpeg-turbo.a", "liblibopenjp2.a", "liblibpng.a", "libquirc.a"
			};
			...
			string[] OpenCVLibName = { "libopencv_calib3d.a", "libopencv_flann.a","libopencv_gapi.a", "libopencv_highgui.a",
				...
				"libopencv_videostab.a", "libopencv_dnn.a", "libopencv_features2d.a", "libopencv_videoio.a", "libopencv_core.a"
