...
void FOpenCVModule::StartupModule()
{
	...
	//OpenCV_WorldD_Handler = FPlatformProcess::GetDllHandle(*(LibraryPath + TEXT("opencv_world455d.dll")));
	OpenCV_FFmpeg_Handler = FPlatformProcess::GetDllHandle(*(LibraryPath + TEXT("opencv_videoio_ffmpeg455_64.dll")));
...
void FOpenCVModule::ShutdownModule()
{
	...
	//FPlatformProcess::FreeDllHandle(OpenCV_WorldD_Handler);
	//OpenCV_WorldD_Handler = nullptr;
